...
const appState = {
    ...
    currentMetrics: null,
    standardizationParams: null // Store standardization parameters for reuse
};
...
function preprocessData() {
    try {
        ...
        // Shuffle and split data BEFORE preprocessing
...
async function trainModel() {
    try {
        ...
        const history = await appState.model.fit(features, targets, {
            epochs: epochs,
            batchSize: batchSize,
            validationData: [valFeatures, valTargets], // Use explicit validation data
            verbose: 0,
            callbacks: {
